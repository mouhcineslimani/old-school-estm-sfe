...
@section('content')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span style="font-size: 1.2em ;"> بطاقات </span>  
            </li>
        </ul> 
    </div>
     <div>
       ...
       <div class="container-fluid">
        <div class="row g-3">
            <div class="col-sm-12 text-center"> 
                <div class="h1"> بطاقات الاستطلاع </div>
            </div>
        </div>
        <br/>
        <div class="row g-3">
            <div class="col-lg-12">
                <form action="{{ url('') }}" method="get"> 
                    ...
                    <button class="btn btn-sm btn-primary text-center " type="submit" >
                     ...
                     <a class="btn btn-primary pull-right btn-sm"  href="/cartes" style="width:90px !important ; " > تحديث</a>
                </form>
               <br/><br/>
            </div>
        </div>
